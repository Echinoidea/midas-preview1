...
function mapRiskLevel(riskLevel) {
    var rl = riskLevel.trim().toLowerCase();
    if (rl === "marked")
        return "HIGH";
    if (rl === "moderate" || rl === "moderated")
        return "SOME";
    if (rl === "very low to mild")
        return "LOW";
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var filePath, parser, batchSize, batch, totalInserted, counter, _a, parser_1, parser_1_1, record, riskLookupId, factor, value, lower, upper, hasRisk, riskLevel, confidence, dataRow, result, e_1_1, result;
        var _b, e_1, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    filePath = "/home/gabriel/code/data/MIDAS Website/results/midasrisk_lookup.csv";
                ...
                case 3:
                    ...
                    return [4 /*yield*/, prisma_1.default.midasRisk.createMany({
                            data: batch,
                            skipDuplicates: true,
                        })];
                case 4:
                    ...
                    console.log("".concat(counter, " Inserted ").concat(result.count, " records; total: ").concat(totalInserted));
                    batch = [];
                    _e.label = 5;
                case 5:
                    _a = true;
                ...
                case 14:
                    result = _e.sent();
                    totalInserted += result.count;
                    console.log("".concat(counter, " (final batches) Inserted ").concat(result.count, " records; total: ").concat(totalInserted));
                    _e.label = 15;
                case 15:
                    counter += 1;
